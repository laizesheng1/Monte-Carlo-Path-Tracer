...
Scatterinfo BRDF::lambertian_diffuse(hitInfo& info) {
...
Scatterinfo BRDF::blinn_phong_specular(hitInfo& info) {
...
Scatterinfo BRDF::specular_reflection_and_transmission(hitInfo& info) {
    coordiantetransform onb(info.normal);
